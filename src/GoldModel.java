...
public class GoldModel extends GameUtilites  {
    ...
    public GoldModel() {
        ...
        for (int i = 0; i < size.width; i++) {
            for (int j = 0; j < size.height; j++) {
                setGameboardState(gameboardState, i, j, BLANK_TILE);
            }
        }

        // Insert the collector in the middle of the gameboard.
        this.collectorPos = new Position(size.width / 2, size.height / 2);
        setGameboardState(gameboardState, this.collectorPos, COLLECTOR_TILE);
    ...
    private void addCoin() {
        ...
        setGameboardState(gameboardState, newCoinPos, COIN_TILE);
    ...
    public void gameUpdate(final int lastKey) throws GameOverException {
        ...
        setGameboardState(gameboardState, this.collectorPos, BLANK_TILE);
        ...
        this.coins.remove(0);
        setGameboardState(gameboardState, oldCoinPos, BLANK_TILE);
